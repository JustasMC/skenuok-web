    ...
    <section className="relative overflow-hidden border-b border-[var(--color-border)]/90">
      ...
      <div className="site-shell relative flex flex-col gap-10 pb-16 pt-14 sm:gap-12 sm:pb-24 sm:pt-20 md:pb-28 lg:flex-row lg:items-stretch lg:justify-between lg:gap-16 lg:pt-24">
        <div className="site-enter flex max-w-2xl flex-col justify-center space-y-7 sm:space-y-8">
          ...
          <div className="rounded-xl border border-[var(--color-border)]/80 bg-[color-mix(in_oklab,var(--color-surface)_88%,transparent)] px-4 py-3.5 text-sm leading-relaxed text-zinc-400 backdrop-blur-sm sm:px-5">
            <span className="text-zinc-500">Išbandykite:</span>{" "}
            <Link
              href="/tools/scanner"
            ...
            <span className="text-zinc-500"> arba </span>
            <Link
            ...
            <span className="text-zinc-500"> — tada peržiūrėkite </span>
            <a
              href="#duk"
        ...
        <dl className="grid grid-cols-2 gap-2.5 sm:gap-3">
          {stats.map((item) => (
            ...
            >
              <dt className="text-[10px] font-semibold uppercase tracking-wide text-zinc-500">{item.k}</dt>
